    ...
    <el-card>
      ...
      <el-form :inline="true" :model="searchForm" class="search-form">
        ...
        <el-form-item label="协议类型">
          <el-select v-model="searchForm.protocolType" placeholder="请选择" clearable>
    ...
    >
      <el-tabs v-model="thingModelTab">
        <el-tab-pane label="属性定义" name="properties">
          <div class="thing-model-section">
            <el-button type="primary" size="small" @click="addProperty" style="margin-bottom: 10px">
              添加属性
            </el-button>
        ...
        <el-tab-pane label="事件定义" name="events">
          <div class="thing-model-section">
            <el-button type="primary" size="small" @click="addEvent" style="margin-bottom: 10px">
              添加事件
            </el-button>
        ...
        <el-tab-pane label="服务定义" name="services">
          <div class="thing-model-section">
            <el-button type="primary" size="small" @click="addService" style="margin-bottom: 10px">
              添加服务
            </el-button>
...
// 物模型编辑
async function handleThingModel(row: any) {
...
// 保存物模型
async function handleSaveThingModel() {
